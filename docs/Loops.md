...
**Источник: whsum.c (while), dowhl.c (do-while), loopspec.c**
...
![nested_outer /Od](loops-ir-graphs/nested_outer_Od.png)
...
**Источник: forbk.c (break), forcnt.c (continue), whbrk.c, whcnt.c, loopspec.c**
